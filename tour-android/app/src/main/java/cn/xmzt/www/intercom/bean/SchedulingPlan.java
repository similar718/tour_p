...
public class SchedulingPlan {
    ...
    public SchedulingPlan(TourTripDetailNewBean.LineRouteListVOBean.DetailVOListBean plan,TourTripDetailNewBean.LineRouteListVOBean.DetailVOListBean.FirstBean first,TourTripDetailNewBean.LineRouteListVOBean.DetailVOListBean.EatBean eat, int planType,boolean start) {
        this.plan = plan;
