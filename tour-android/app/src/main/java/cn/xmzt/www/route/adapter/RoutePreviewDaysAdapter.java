 ...
 * 共享导航——主界面的天数
 */
public class RoutePreviewDaysAdapter extends BaseRecycleViewAdapter<SettingDestinationTypeInfo, RoutePreviewDaysAdapter.ItemHolder> {
    @Override
    ...
    public RoutePreviewDaysAdapter(Context context){
        mContext = context;
    }
        ...
        public ItemHolder(ItemSharedNavigationDaysTypeBinding itemBinding) {
            ...
            itemBinding.itemLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ((RoutePreviewMapActivity)mContext).OnBottomListClickListener(getAdapterPosition(),0);
                }
            });
        }
