...
public class MustPlayBannerLayout extends FrameLayout {
    ...
    public MustPlayBannerLayout(Context context) {
        this(context, null);
    }

    public MustPlayBannerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MustPlayBannerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        if (mSelectedDrawable == null) {
            ...
            selectedGradientDrawable.setColor(Color.parseColor("#40BAFF"));
        ...
        if (mUnselectedDrawable == null) {
            ...
            unSelectedGradientDrawable.setColor(Color.parseColor("#D3E0E7"));
        ...
        try {
            Field field = mRecyclerView.getClass().getDeclaredField("mMaxFlingVelocity");
            field.setAccessible(true);
            field.set(mRecyclerView, 1000);
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (index != currentIndex) {
                    index = currentIndex;
                    EventBus.getDefault().postSticky(new IndexEvent(index));
                }
                refreshIndicator();
            }
        });
