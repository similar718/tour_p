...
import cn.xmzt.www.mine.adapter.MessageCenterActivityAdapter;
 ...
 * 系统活动消息
 */
public class SysActivityMSGFrament extends BaseFragment<SysMsgViewModel, FragmentSysMsgBinding> implements ItemListener {
    ...
    private MessageCenterActivityAdapter adapter;
    ...
    protected void initData() {
        ...
        adapter = new MessageCenterActivityAdapter();
