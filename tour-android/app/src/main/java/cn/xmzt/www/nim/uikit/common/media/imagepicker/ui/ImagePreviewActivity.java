...
import cn.xmzt.www.nim.uikit.common.adapter.BaseAdapter;
import cn.xmzt.www.nim.uikit.common.adapter.BaseDelegate;
import cn.xmzt.www.nim.uikit.common.adapter.BaseViewHolder;
import cn.xmzt.www.nim.uikit.common.adapter.ItemClickListerAdapter;
...
import cn.xmzt.www.nim.uikit.common.media.imagepicker.view.SuperCheckBox;
            ...
            public void onClick(View v) {
                ...
                if (mCbCheck.isSelected()) {
                    ...
                    if (!TextUtils.isEmpty(error)) {
                        ...
                        ToastUtils.showText(ImagePreviewActivity.this, error);
                        return;
                    }
                }
