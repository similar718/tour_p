...
import cn.xmzt.www.view.datepicker.PickerView;
...
public class SharedNavigationDatePickerDialog implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private TextView mTvHourUnit, mTvMinuteUnit,mTvYaer,mTvMonth,mTvDay;
    private TextView mSettingEndTime,mCancelTv,mSureTv;
    private TextView mDestinationContent;
    private TextView mDestinationDetail;
     ...
     */
    public SharedNavigationDatePickerDialog(Context context, Callback callback, String beginDateStr, String endDateStr) {
     ...
     */
    public SharedNavigationDatePickerDialog(Context context, Callback callback, long beginTimestamp, long endTimestamp) {
    ...
    private void initView() {
        ...
        mPickerDialog.findViewById(R.id.cancel_tv).setOnClickListener(this);
        mPickerDialog.findViewById(R.id.confirm_tv).setOnClickListener(this);
        ...
        mSettingEndTime = mPickerDialog.findViewById(R.id.dialog_setting_time_content_tv);//设置结果控件
        mCancelTv = mPickerDialog.findViewById(R.id.cancel_tv);//取消设置
        mSureTv = mPickerDialog.findViewById(R.id.confirm_tv);//确定设置
        mDestinationContent = mPickerDialog.findViewById(R.id.dialog_des_content_tv);//确定设置
        mDestinationDetail = mPickerDialog.findViewById(R.id.dialog_des_detail);//当前位置与选择位置之前的详请信息
        mLoading = mPickerDialog.findViewById(R.id.loading);//加载数据
     ...
     */
    public void show(String dateStr,String destinationStr,String detail) {
    ...
    public void showUpdate(String detail){
        if (!TextUtils.isEmpty(detail)){
            mLoading.setVisibility(View.GONE);
            mDestinationDetail.setText(detail);
        } else {
