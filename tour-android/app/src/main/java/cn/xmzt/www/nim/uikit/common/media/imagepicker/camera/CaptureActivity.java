package cn.xmzt.www.nim.uikit.common.media.imagepicker.camera;
...
import cn.xmzt.www.nim.uikit.common.media.imagepicker.ui.ImagePreviewRetakeActivity;
import cn.xmzt.www.nim.uikit.common.media.imagepicker.video.GLVideoConfirmActivity;
...
public class CaptureActivity extends AppCompatActivity {
    ...
    private void stopMediaRecorder() {
        ...
        if (currentTime <= RECORD_MIN_TIME) {
            ToastUtils.showText(this, "录制时间过短");
        } else {
