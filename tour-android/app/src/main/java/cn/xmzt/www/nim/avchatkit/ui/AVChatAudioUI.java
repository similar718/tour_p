package cn.xmzt.www.nim.avchatkit.ui;
...
import cn.xmzt.www.nim.avchatkit.activity.AVChatActivity;
import cn.xmzt.www.nim.avchatkit.common.imageview.HeadImageView;
import cn.xmzt.www.nim.avchatkit.common.log.LogUtil;
import cn.xmzt.www.nim.avchatkit.common.util.NetworkUtil;
import cn.xmzt.www.nim.avchatkit.common.widgets.ToggleListener;
import cn.xmzt.www.nim.avchatkit.common.widgets.ToggleState;
import cn.xmzt.www.nim.avchatkit.common.widgets.ToggleView;
...
public class AVChatAudioUI implements View.OnClickListener, ToggleListener {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.refuse) {
            ...
            if (isInSwitch) {
                ToastUtils.showText(context, R.string.avchat_in_switch);
            } else {
