...
import cn.xmzt.www.databinding.ActivitySharedNavigationGuideBackBinding;
 ...
 */
public class SharedNavigationGuideActivityBackUp extends TourBaseActivity<SharedNavigationGuideViewModel, ActivitySharedNavigationGuideBackBinding> implements AMapNaviViewListener, AMapNaviListener {
...
//    private int routeId = -1;
    ...
    protected int setLayoutId() {
        return R.layout.activity_shared_navigation_guide_back;
    }
...
//            mAmap.setOnMarkerClickListener(mMarkerListener);
    ...
    private final int HANDLER_SEND_SECOND = 5 * 1000;
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == HANDLER_GET_MEMBER_INFO){
                if (!mDestroyActivity) {
                    getUserInfoToDataBase();
                    if (!mDestroyActivity) {
                        mHandler.sendEmptyMessageDelayed(HANDLER_GET_MEMBER_INFO, HANDLER_SEND_SECOND);
                    }
                }
            }
        }
...
//                setRefreshOption(); // TODO
        ...
        dataBinding.amapExitGuideTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SharedNavigationGuideActivityBackUp.this.finish();
                ActivityUtils.finishActivity(SharedNavigationGoHereActivityBackUp.class);
            }
        });
    ...
    private void setMinSetting(){
        if (FloatPermissionManager.getInstance().applyFloatWindow(SharedNavigationGuideActivityBackUp.this)){
            // 权限成功
            ...
            EventBus.getDefault().post(new GuideMinTypeEvent(1));
...
//        Toast.makeText(this, "init navi Failed", Toast.LENGTH_SHORT).show();
    ...
    public void onInitNaviSuccess() {
        // 目前逻辑是上一个界面传递过来的数据，这里就不需要在重新计算一次算路的操作，否则会跟前面的界面选择的路径不一致
//        setRefreshOption();
    }
...
//        }
        ...
        TextViewUtil.setTextViewSize(dataBinding.amapShengyuTimeTv, SharedNavigationGuideActivityBackUp.this,AMapUtil.getFriendlyTime(mPathRetainTime),mIsNight);
...
//            Toast.makeText(this, "当前在辅路", Toast.LENGTH_SHORT).show();
    ...
    private void setDayNightModeUpdateView(){
        // update dialog
        if (mIsNight) { // night
            StatusBarUtil.changeStatusBarColor(SharedNavigationGuideActivityBackUp.this,R.color.black_guide_status_bg);
            StatusBarUtil.setStatusBarLightMode(SharedNavigationGuideActivityBackUp.this,false);
            ...
            StatusBarUtil.changeStatusBarColor(SharedNavigationGuideActivityBackUp.this,R.color.white_guide_status_bg);
            StatusBarUtil.setStatusBarLightMode(SharedNavigationGuideActivityBackUp.this,true);
...
//            dataBinding.amapMinIv.setVisibility(View.VISIBLE); // min
    ...
    private void setShowBottomView() {
        android.view.animation.Animation animBottomOut = AnimationUtils.loadAnimation(SharedNavigationGuideActivityBackUp.this, R.anim.map_list_bottom_in);
    ...
    private void setHideBottomView() {
        android.view.animation.Animation animBottomOut = AnimationUtils.loadAnimation(SharedNavigationGuideActivityBackUp.this, R.anim.map_list_bottom_out);
        animBottomOut.setDuration(240);
    ...
    private void setShowHideExitInfo() {
        android.view.animation.Animation animInFromLeft = AnimationUtils.loadAnimation(SharedNavigationGuideActivityBackUp.this, R.anim.in_from_left);
        ...
        android.view.animation.Animation animOutToRight = AnimationUtils.loadAnimation(SharedNavigationGuideActivityBackUp.this, R.anim.out_to_right);
    ...
    private void setShowHideInfoExit() {
        android.view.animation.Animation animInFromRight = AnimationUtils.loadAnimation(SharedNavigationGuideActivityBackUp.this, R.anim.in_from_right);
        ...
        android.view.animation.Animation animOutToLeft = AnimationUtils.loadAnimation(SharedNavigationGuideActivityBackUp.this, R.anim.out_to_left);
    ...
    private void addMyCarAndPersonLocationMarker(boolean isCar, LatLng latLng, int radiusmarker, Bitmap bitmapurl, String type, String name, String carinfo, String userId,float distance,long time) {
        ...
        if (mAmap != null) {
            ...
            TextView tvNickName = (TextView) view.findViewById(R.id.maker_nick_name_tv); // 用户昵称的显示
            RelativeLayout rl_bg = (RelativeLayout) view.findViewById(R.id.rl_bg); // 用户昵称的显示
            if (mIsNight){ // 晚上
            ...
            TextView tvType = (TextView) view.findViewById(R.id.maker_type_tv); // 用户类型的显示问题
            TextView tvCar = null; // 是车辆的情况 车辆的显示
            ImageView iv_car_bg = null; // 是车辆的情况 车辆的图片显示
            if (isCar) { // 车辆
                tvCar = (TextView) view.findViewById(R.id.maker_car_info_tv);
            ...
            ImageView ivBottomBg = (ImageView) view.findViewById(R.id.maker_share_navigation_bg_iv);
            RoundImageView ivheadImg = (RoundImageView) view.findViewById(R.id.maker_head_icon);
