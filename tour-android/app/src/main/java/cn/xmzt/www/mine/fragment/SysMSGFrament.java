...
import cn.xmzt.www.mine.adapter.MessageCenterSystemAdapter;
 ...
 * 系统消息通知
 */
public class SysMSGFrament extends BaseFragment<SysMsgViewModel, FragmentSysMsgBinding> implements ItemListener {
    ...
    private MessageCenterSystemAdapter adapter;
    ...
    protected void initData() {
        ...
        adapter = new MessageCenterSystemAdapter();
