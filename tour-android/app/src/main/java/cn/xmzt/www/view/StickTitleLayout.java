...
public class StickTitleLayout extends ViewGroup implements NestedScrollingParent2 {

	private static final String TAG = StickTitleLayout.class.getSimpleName();

	private View topView;
	private View indicationView;
	private View bottomView;

	public StickTitleLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
