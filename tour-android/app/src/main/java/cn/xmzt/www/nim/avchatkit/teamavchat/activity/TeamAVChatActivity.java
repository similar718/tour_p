package cn.xmzt.www.nim.avchatkit.teamavchat.activity;
...
import cn.xmzt.www.nim.avchatkit.common.log.LogUtil;
import cn.xmzt.www.nim.avchatkit.common.permission.MPermission;
import cn.xmzt.www.nim.avchatkit.common.permission.annotation.OnMPermissionDenied;
import cn.xmzt.www.nim.avchatkit.common.permission.annotation.OnMPermissionGranted;
import cn.xmzt.www.nim.avchatkit.common.permission.annotation.OnMPermissionNeverAskAgain;
import cn.xmzt.www.nim.avchatkit.common.recyclerview.decoration.SpacingDecoration;
import cn.xmzt.www.nim.avchatkit.common.util.ScreenUtil;
import cn.xmzt.www.nim.avchatkit.config.AVChatConfigs;
import cn.xmzt.www.nim.avchatkit.config.AVPrivatizationConfig;
import cn.xmzt.www.nim.avchatkit.controll.AVChatSoundPlayer;
import cn.xmzt.www.nim.avchatkit.teamavchat.TeamAVChatNotification;
import cn.xmzt.www.nim.avchatkit.teamavchat.TeamAVChatVoiceMuteDialog;
import cn.xmzt.www.nim.avchatkit.teamavchat.adapter.TeamAVChatAdapter;
import cn.xmzt.www.nim.avchatkit.teamavchat.module.SimpleAVChatStateObserver;
...
import static cn.xmzt.www.nim.avchatkit.teamavchat.module.TeamAVChatItem.TYPE.TYPE_DATA;
...
public class TeamAVChatActivity extends UI {
    ...
    public void onBasicPermissionFailed() {
        ToastUtils.showText(this, "音视频通话所需权限未全部授权，部分功能可能无法正常运行！");
        onPermissionChecked();
    }
    ...
    private void showToast(String content) {
        ToastUtils.showText(TeamAVChatActivity.this, content);
    }
