package cn.xmzt.www.nim.uikit.business.recent;
...
public interface RecentContactsCallback {
    ...
    /**
     * 有未读数更新时的回调函数，供更新除最近会话列表外的其他界面和未读指示
     *
    ...
    /**
     * 最近会话点击响应回调函数，以供打开会话窗口时传入定制化参数，或者做其他动作
     *
     * @param recent 最近会话
     */
