 ...
 * 导航路线图层类。
 */
public class SharedGoHereDrivingRouteOverlay extends RouteOverlay{
     ...
     */
    public SharedGoHereDrivingRouteOverlay(Context context, AMap amap, DrivePath path,
                                           LatLonPoint start, LatLonPoint end, List<LatLonPoint> throughPointList,boolean mIsAddStartEndMaker) {
    	super(context);
    	mContext = context; 
        mAMap = amap; 
        this.drivePath = path;
