...
import cn.xmzt.www.nim.avchatkit.TeamAVChatProfile;
...
import cn.xmzt.www.nim.im.session.action.AVChatAction;
import cn.xmzt.www.nim.im.session.action.AckMessageAction;
import cn.xmzt.www.nim.im.session.action.FileAction;
import cn.xmzt.www.nim.im.session.action.GuessAction;
import cn.xmzt.www.nim.im.session.action.RTSAction;
import cn.xmzt.www.nim.im.session.action.RedPacketAction;
import cn.xmzt.www.nim.im.session.action.SnapChatAction;
import cn.xmzt.www.nim.im.session.action.TeamAVChatAction;
import cn.xmzt.www.nim.im.session.action.TipAction;
import cn.xmzt.www.nim.im.session.activity.AckMsgInfoActivity;
import cn.xmzt.www.nim.im.session.activity.MessageInfoActivity;
import cn.xmzt.www.nim.im.session.extension.CustomAttachParser;
import cn.xmzt.www.intercom.attachment.CustomAttachment;
...
import cn.xmzt.www.nim.im.session.extension.RedPacketOpenedAttachment;
import cn.xmzt.www.nim.im.session.extension.SnapChatAttachment;
import cn.xmzt.www.nim.im.session.extension.StickerAttachment;
import cn.xmzt.www.nim.im.session.search.SearchMessageActivity;
import cn.xmzt.www.nim.im.session.viewholder.MsgViewHolderAVChat;
import cn.xmzt.www.nim.im.session.viewholder.MsgViewHolderDefCustom;
import cn.xmzt.www.nim.im.session.viewholder.MsgViewHolderFile;
import cn.xmzt.www.nim.im.session.viewholder.MsgViewHolderGuess;
import cn.xmzt.www.nim.im.session.viewholder.MsgViewHolderOpenRedPacket;
import cn.xmzt.www.nim.im.session.viewholder.MsgViewHolderRTS;
import cn.xmzt.www.nim.im.session.viewholder.MsgViewHolderRedPacket;
import cn.xmzt.www.nim.im.session.viewholder.MsgViewHolderSnapChat;
import cn.xmzt.www.nim.im.session.viewholder.MsgViewHolderSticker;
import cn.xmzt.www.nim.im.session.viewholder.MsgViewHolderTip;
...
import cn.xmzt.www.nim.uikit.api.wrapper.NimMessageRevokeObserver;
import cn.xmzt.www.intercom.actions.BaseAction;
import cn.xmzt.www.nim.uikit.business.session.helper.MessageListPanelHelper;
...
import cn.xmzt.www.nim.uikit.business.session.viewholder.MsgViewHolderUnknown;
...
import cn.xmzt.www.nim.uikit.common.ui.dialog.EasyAlertDialogHelper;
import cn.xmzt.www.nim.uikit.common.ui.popupmenu.NIMPopupMenu;
import cn.xmzt.www.nim.uikit.common.ui.popupmenu.PopupMenuItem;
...
public class SessionHelper {
    ...
    public static void startTeamSession(Context context, String tid, String lineId, int tripId) {
        startTeamSession(context, tid, lineId, tripId, null);
    }
    ...
    public static void startTeamSession(Context context, String tid, String lineId, int tripId, IMMessage anchor) {
        NimUIKit.startTeamSession(context, tid, lineId, tripId, getTeamCustomization(tid), anchor);
    }
    ...
    private static SessionCustomization getP2pCustomization() {
        if (p2pCustomization == null) {
            ...
            //            p2pCustomization.backgroundUri = "android.resource://com.jm.selfdriving.nim.demo/drawable/bk"
...
*/
                onHeadImageViewClick(context, message.getSessionId(), message.getFromAccount());
     ...
     * @param userID    // 用户id
     */
    public static void onHeadImageViewClick(Context context,String account, String userID) {
        // 打开群成员信息详细页面
