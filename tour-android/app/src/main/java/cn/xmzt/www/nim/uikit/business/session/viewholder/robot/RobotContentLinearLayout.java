package cn.xmzt.www.nim.uikit.business.session.viewholder.robot;
...
import cn.xmzt.www.nim.uikit.business.robot.model.RobotBotContent;
import cn.xmzt.www.nim.uikit.business.robot.model.RobotResponseContent;
import cn.xmzt.www.nim.uikit.business.robot.parser.elements.base.Element;
import cn.xmzt.www.nim.uikit.business.robot.parser.elements.element.ImageElement;
import cn.xmzt.www.nim.uikit.business.robot.parser.elements.element.TextElement;
import cn.xmzt.www.nim.uikit.business.robot.parser.elements.group.LinkElement;
import cn.xmzt.www.nim.uikit.business.robot.parser.elements.group.TemplateRoot;
...
public class RobotContentLinearLayout extends LinearLayout {
    ...
    private void convertTemplateToViews(final TemplateRoot template, final ClickableChildView robot) {
        List<cn.xmzt.www.nim.uikit.business.robot.parser.elements.group.LinearLayout> robotLinearLayouts = template.getElements();
        if (robotLinearLayouts == null) {
            return;
        }
        for (cn.xmzt.www.nim.uikit.business.robot.parser.elements.group.LinearLayout robotLinearLayout : robotLinearLayouts) {
