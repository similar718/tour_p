...
import cn.xmzt.www.nim.uikit.api.wrapper.MessageRevokeTip;
import cn.xmzt.www.nim.uikit.api.wrapper.NimUserInfoProvider;
...
public class NimSDKOptionConfig {
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        // 点击通知需要跳转到的界面
        config.notificationEntrance = TeamRoomActivity.class;
        ...
        // 通知铃声的uri字符串
        config.notificationSound = "android.resource://com.jm.selfdriving/raw/msg";
