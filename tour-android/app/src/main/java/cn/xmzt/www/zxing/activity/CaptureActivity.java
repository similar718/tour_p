package cn.xmzt.www.zxing.activity;
...
import cn.xmzt.www.zxing.camera.CameraManager;
import cn.xmzt.www.zxing.decoding.CaptureActivityHandler;
import cn.xmzt.www.zxing.decoding.InactivityTimer;
import cn.xmzt.www.zxing.decoding.RGBLuminanceSource;
import cn.xmzt.www.zxing.view.ViewfinderView;
...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            RelativeLayout.LayoutParams mLayoutParams= (RelativeLayout.LayoutParams) toolbar.getLayoutParams();
...
//        }
    ...
    protected void onActivityResult(final int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode==RESULT_OK) {
            switch (requestCode) {
                case REQUEST_CODE_QR_DROID: {
                    if(photo_path==null){
                        photo_path=PhotoFitSevent.handleImageBeforeKitKat(data, this);
                    }
                    if(photo_path==null){
                        ToastUtils.showText(this,"请选择图片路径");
                    }else {
                        AsyncUtil.async(new Function() {
                            @Override
                            public Object apply(Object o) throws Exception {
                                //获取解析结果
                                Result ret = parseQRcodeBitmap(photo_path);
                                if(ret!=null){
                                    return ret;
                                }else {
                                    return "识别失败";
                            ...
                            public void accept(Object o) throws Exception {
                                if (o instanceof Result) {
                                    handleDecode((Result) o,null);
                                } else {
                                    ToastUtils.showText(CaptureActivity.this, "Scan failed!");
...
//            setVolumeControlStream(AudioManager.STREAM_MUSIC);
    ...
    private static final int REQUEST_CODE_QR_DROID = 112;
    @Override
    public void onClick(View v) {
        if(v.getId()==R.id.scanner_toolbar_back){
            ...
            startActivityForResult(intent2, REQUEST_CODE_QR_DROID);
        }
    }
    ...
    private Result parseQRcodeBitmap(String bitmapPath){
        ...
        String characterSet= StringUtils.guessEncoding(rgbLuminanceSource.getMatrix(),null);
