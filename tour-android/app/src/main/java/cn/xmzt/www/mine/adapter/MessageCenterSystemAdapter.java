...
import cn.xmzt.www.databinding.ItemMessageTypeSystemBinding;
...
public class MessageCenterSystemAdapter extends BaseRecycleViewAdapter<MessageBean, MessageCenterSystemAdapter.ItemHolder> {

    @Override
    public ItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ItemMessageTypeSystemBinding itemRouteBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.item_message_type_system, parent, false);
    ...
    class ItemHolder extends RecyclerView.ViewHolder {
        ...
        ItemMessageTypeSystemBinding itemBinding;

        public ItemHolder(ItemMessageTypeSystemBinding itemBinding) {
            ...
            itemBinding.itemLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(!TextUtils.isEmpty(url)){
                        SchemeActivityUtil.startToActivity(view.getContext(),4,mb.getTitle(),url);
                    }
                }
            });
        }
