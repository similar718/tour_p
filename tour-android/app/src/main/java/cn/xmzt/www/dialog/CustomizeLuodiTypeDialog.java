...
import cn.xmzt.www.databinding.DialogCustomizeLuodiTypeBinding;


/**
 * 定制界面的设置是否落地dialog
 */
public class CustomizeLuodiTypeDialog extends Dialog {
	private Context mContext;

	private View.OnClickListener onClickListener;

	public CustomizeLuodiTypeDialog(Context context) {
		super(context, R.style.dialog_custom);
		this.mContext = context;
	}

	DialogCustomizeLuodiTypeBinding binding;

	public CustomizeLuodiTypeDialog(Context context, View.OnClickListener onClickListener) {
		super(context, R.style.dialog_custom);
		this.mContext = context;
		this.onClickListener = onClickListener;
		binding = DataBindingUtil.inflate(LayoutInflater.from(mContext), R.layout.dialog_customize_luodi_type, null, false);
