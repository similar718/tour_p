...
import cn.xmzt.www.nim.im.contact.constant.UserConstant;
...
import cn.xmzt.www.nim.uikit.common.ui.dialog.EasyEditDialog;
        ...
        if (DemoCache.getAccount() != null && !DemoCache.getAccount().equals(account)) {
            ...
            if (NIMClient.getService(FriendService.class).isMyFriend(account)) {
                ...
                if (stickySwitch == null) {
                    stickySwitch = addToggleItemView(KEY_RECENT_STICKY, R.string.recent_sticky, false);
                } else {
                    setToggleBtn(stickySwitch, false);
                }
            }
            updateUserOperatorView();
        }
            ...
            if (KEY_RECENT_STICKY.equals(key)) {
                ...
                if (checkState) {
                    ...
                    if (recentContact == null) {
                        // TravelListFragment 的 MsgServiceObserve#observeRecentContact 观察者会收到通知
                    ...
                    // 之前存在，更新置顶flag
                        ...
                        CommonUtil.addTag(recentContact, 9999);
                ...
                //取消置顶
                    ...
                    if (recentContact != null) {
                        CommonUtil.removeTag(recentContact, 9999);
                        NIMClient.getService(MsgService.class).updateRecentAndNotify(recentContact);
                    }
                }
                return;
