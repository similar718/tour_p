package cn.xmzt.www.intercom.api;
...
public class NimUIKit {
     ...
     * @param anchor  跳转到指定消息的位置，不需要跳转填null
     */
    public static void startTeamSession(Context context, String tid, String lineId, int tripId, SessionCustomization customization, IMMessage anchor) {
        NimUIKitImpl.startTeamSession(context, tid, lineId, tripId, customization, anchor);
    }
    ...
    public static void startTeamInfo(Context context, String teamId, String lineId, int tripId) {
        NimUIKitImpl.startTeamInfo(context, teamId, lineId, tripId);
    }
