package cn.xmzt.www.nim.im.rts;

import cn.xmzt.www.nim.im.session.extension.RTSAttachment;
import cn.xmzt.www.nim.rtskit.RTSKit;
import cn.xmzt.www.nim.rtskit.api.IUserInfoProvider;
import cn.xmzt.www.nim.rtskit.api.listener.RTSEventListener;
import cn.xmzt.www.nim.rtskit.common.log.ILogUtil;
...
public class RTSHelper {
    ...
    private static void setUserInfoProvider() {
        RTSKit.setUserInfoProvider(new IUserInfoProvider() {
