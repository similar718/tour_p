package cn.xmzt.www.intercom.impl;
...
import cn.xmzt.www.nim.uikit.api.UIKitInitStateListener;
import cn.xmzt.www.intercom.api.UIKitOptions;
import cn.xmzt.www.nim.uikit.api.model.chatroom.ChatRoomMemberChangedObservable;
import cn.xmzt.www.nim.uikit.api.model.chatroom.ChatRoomProvider;
import cn.xmzt.www.nim.uikit.api.model.chatroom.ChatRoomSessionCustomization;
import cn.xmzt.www.nim.uikit.api.model.contact.ContactChangedObservable;
import cn.xmzt.www.nim.uikit.api.model.contact.ContactEventListener;
import cn.xmzt.www.nim.uikit.api.model.contact.ContactProvider;
...
import cn.xmzt.www.nim.uikit.api.model.main.OnlineStateChangeObservable;
import cn.xmzt.www.nim.uikit.api.model.main.OnlineStateContentProvider;
import cn.xmzt.www.nim.uikit.api.model.recent.RecentCustomization;
...
import cn.xmzt.www.nim.uikit.api.model.session.SessionEventListener;
import cn.xmzt.www.nim.uikit.api.model.superteam.SuperTeamChangedObservable;
import cn.xmzt.www.nim.uikit.api.model.superteam.SuperTeamProvider;
import cn.xmzt.www.nim.uikit.api.model.team.TeamChangedObservable;
import cn.xmzt.www.nim.uikit.api.model.team.TeamProvider;
import cn.xmzt.www.nim.uikit.api.model.user.IUserInfoProvider;
import cn.xmzt.www.nim.uikit.api.model.user.UserInfoObservable;
import cn.xmzt.www.nim.uikit.business.chatroom.fragment.ChatRoomMessageFragment;
import cn.xmzt.www.nim.uikit.business.chatroom.viewholder.ChatRoomMsgViewHolderBase;
import cn.xmzt.www.nim.uikit.business.chatroom.viewholder.ChatRoomMsgViewHolderFactory;
import cn.xmzt.www.nim.uikit.business.contact.selector.activity.ContactSelectActivity;
import cn.xmzt.www.nim.uikit.business.preference.UserPreferences;
...
import cn.xmzt.www.nim.uikit.business.session.module.MsgForwardFilter;
import cn.xmzt.www.nim.uikit.business.session.module.MsgRevokeFilter;
import cn.xmzt.www.intercom.business.session.viewholder.MsgViewHolderBase;
import cn.xmzt.www.intercom.business.session.viewholder.MsgViewHolderFactory;
import cn.xmzt.www.nim.uikit.business.team.activity.NormalTeamInfoActivity;
...
import cn.xmzt.www.nim.uikit.impl.cache.ChatRoomCacheManager;
import cn.xmzt.www.nim.uikit.impl.cache.DataCacheManager;
import cn.xmzt.www.nim.uikit.impl.customization.DefaultContactEventListener;
import cn.xmzt.www.nim.uikit.impl.customization.DefaultP2PSessionCustomization;
import cn.xmzt.www.nim.uikit.impl.customization.DefaultRecentCustomization;
import cn.xmzt.www.nim.uikit.impl.customization.DefaultTeamSessionCustomization;
import cn.xmzt.www.nim.uikit.impl.provider.DefaultChatRoomProvider;
import cn.xmzt.www.nim.uikit.impl.provider.DefaultContactProvider;
import cn.xmzt.www.nim.uikit.impl.provider.DefaultRobotProvider;
import cn.xmzt.www.nim.uikit.impl.provider.DefaultSuperTeamProvider;
import cn.xmzt.www.nim.uikit.impl.provider.DefaultTeamProvider;
import cn.xmzt.www.nim.uikit.impl.provider.DefaultUserInfoProvider;
import cn.xmzt.www.nim.uikit.support.glide.ImageLoaderKit;
...
public final class NimUIKitImpl {
    ...
    */
    ...
    public static void startTeamSession(Context context, String tid, String lineId, int tripId, SessionCustomization sessionCustomization, IMMessage anchor) {
        NimUIKitImpl.startChatting(context, tid, lineId, tripId, SessionTypeEnum.Team, sessionCustomization, anchor);
    }
    ...
    public static void startChatting(Context context, String id, String lineId, int tripId, SessionTypeEnum sessionType, SessionCustomization
            customization, IMMessage anchor) {
    }
    ...
    public static void startTeamInfo(Context context, String teamId, String lineId, int tripId) {
        Team team = NimUIKit.getTeamProvider().getTeamById(teamId);
        if (team == null) {
            return;
        }
        if (team.getType() == TeamTypeEnum.Advanced) {
            GroupInfoActivity.start(context, teamId, lineId, tripId); // 启动固定群资料页
