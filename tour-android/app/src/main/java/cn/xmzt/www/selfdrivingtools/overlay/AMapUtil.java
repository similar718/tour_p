...
//		int dis = lenMeter / 10 * 10; // TODO 100以下的显示更精准一点
//		if (dis == 0) {
//			dis = 10;
//		}
...
//	}
	...
	public static String getFriendlyLength_y(int lenMeter) {
		if (lenMeter > 10000) // 10 km
		{
			int dis = lenMeter / 1000;
			return dis + ChString.Kilometer_y;
		}
		if (lenMeter > 1000) {
			float dis = (float) lenMeter / 1000;
			DecimalFormat fnum = new DecimalFormat("##0.0");
			String dstr = fnum.format(dis);
			return dstr + ChString.Kilometer_y;
		}
		if (lenMeter > 100) {
			int dis = lenMeter / 50 * 50;
			return dis + ChString.Meter_y;
		}
//		int dis = lenMeter / 10 * 10; // TODO 100以下的显示更精准一点
//		if (dis == 0) {
//			dis = 10;
//		}
		return lenMeter + ChString.Meter_y;
	}
