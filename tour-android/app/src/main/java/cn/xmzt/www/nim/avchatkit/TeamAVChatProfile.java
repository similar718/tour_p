package cn.xmzt.www.nim.avchatkit;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import cn.xmzt.www.nim.avchatkit.common.Handlers;
import cn.xmzt.www.nim.avchatkit.common.log.LogUtil;
import cn.xmzt.www.nim.avchatkit.common.util.TimeUtil;
import cn.xmzt.www.nim.avchatkit.teamavchat.activity.TeamAVChatActivity;
...
public class TeamAVChatProfile {
    ...
    private boolean isTeamAVChatInvite(JSONObject json) {
        if (json != null) {
            if (json != null && json.containsKey(KEY_ID)){
            ...
            try {
                ...
                if (isTeamAVChatInvite(jsonObject)) {
                    ...
                    if (isTeamAVChatting || AVChatProfile.getInstance().isAVChatting()) {
                        ...
                        ToastUtils.showText(AVChatKit.getContext(), "正在进行视频通话");
                        return;
                    }
    ...
    public boolean checkOfflineOutTime(CustomNotification notification) {
        ...
        LogUtil.ui("rev offline team AVChat request timer = " + time);
