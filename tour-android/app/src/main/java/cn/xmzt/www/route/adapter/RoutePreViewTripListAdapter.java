...
import cn.xmzt.www.route.activity.RoutePreviewMapActivity;
 ...
 */
public class RoutePreViewTripListAdapter extends BaseRecycleViewAdapter<Object, RoutePreViewTripListAdapter.ItemHolder> {
    ...
    public void setData(List<TourTripDetailNewBean.LineRouteListVOBean> mRouteDetailPage) {
        this.datas.clear();

        List<TourTripDetailNewBean.LineRouteListVOBean> lineRouteList = mRouteDetailPage;//trip list
    ...
    public RoutePreViewTripListAdapter(Context context){
        mContext = context;
    }
                    ...
                    public void onClick(View view) {
                        ...
                        if(object instanceof SRouteDetailPlan){
                            if (((SRouteDetailPlan) object).getPlanType() == TYPE_ITEM_4_5){ // 5集结地信息
                                ...
                                ((RoutePreviewMapActivity)mContext).setBottomBlueTextClick(((SRouteDetailPlan) object).getPlan().getStaging().getCoordinateVO().getLatitude(),((SRouteDetailPlan) object).getPlan().getStaging().getCoordinateVO().getLongitude(),getAdapterPosition(),2);
                                }
                                ...
                                if (((SRouteDetailPlan) object).getPlan().getHotel().getCoordinateVO() != null) {
                                    ((RoutePreviewMapActivity) mContext).setBottomBlueTextClick(((SRouteDetailPlan) object).getPlan().getHotel().getCoordinateVO().getLatitude(), ((SRouteDetailPlan) object).getPlan().getHotel().getCoordinateVO().getLongitude(), getAdapterPosition(), 6);
                                } else {
                    ...
                    public void onClick(View view) {
                        ...
                        if(object instanceof SRouteDetailPlan) {
                            if (((SRouteDetailPlan) object).getPlan().getSpot().getCoordinateVO() != null) {
                                ...
                                int type = 7;
                                ((RoutePreviewMapActivity) mContext).setBottomBlueTextClick(lat, lng, position, type);
                            } else {
...
//                                ((RoutePreviewMapActivity) mContext).setSpotVoiceTextClick(((SRouteDetailPlan) object).getPlan().getSpot().getScenicId());
                            }
                        }
                    }
                });
        ...
        private void setViewDate(ItemHolder holder,int position){
            if(dbBinding instanceof ItemSharedNavigationTripDetail1Binding){ // 开始 0
                ...
                if(obj instanceof SRouteDetailPlan){
                    ...
                    itemBinding.tvTitle1.setText(((SRouteDetailPlan) obj).getFirst().getContent());
                }
