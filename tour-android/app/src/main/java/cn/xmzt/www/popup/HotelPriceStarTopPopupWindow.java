 ...
 * @author tanlei
 * @date 2019/8/2
 * @describe 酒店价格星级筛选从上往下的弹出框
 */

public class HotelPriceStarTopPopupWindow extends BasePopupWindow {
    public HotelPriceStarTopPopupWindow(Activity context) {
        this(context, null);
    }

    public HotelPriceStarTopPopupWindow(Activity context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected int setPopupWindowLayoutId() {
        return R.layout.popupwindow_hotel_price_star;
    }
}
