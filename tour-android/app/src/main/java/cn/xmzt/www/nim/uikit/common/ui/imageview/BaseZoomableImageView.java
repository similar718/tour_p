package cn.xmzt.www.nim.uikit.common.ui.imageview;
...
import cn.xmzt.www.nim.uikit.common.util.media.SampleSizeUtil;
...
public abstract class BaseZoomableImageView extends View {
    ...
    // The timer of the last draw operation
    ...
    // Fling a view by a distance over timer
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBitmap != null && !mBitmap.isRecycled()) {
            ...
            if (Build.VERSION.SDK_INT >= MIN_SDK_ENABLE_LAYER_TYPE_HARDWARE
                ...
                // Check if the timer between draws has been met and draw the bitmap
