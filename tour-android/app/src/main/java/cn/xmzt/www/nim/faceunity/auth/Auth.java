package cn.xmzt.www.nim.faceunity.auth;

import cn.xmzt.www.nim.faceunity.utils.ReflectUtils;
...
public class Auth {
    ...
    private static final String AUTH_CLASS_PATH = "com.jm.selfdriving.nim.faceunity.auth.AuthPack";
