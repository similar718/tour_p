package cn.xmzt.www.nim.uikit.business.team.adapter;
...
public class TeamMemberAdapter extends TAdapter {
    ...
    public static class TeamMemberItem {
        ...
        public TeamMemberItem(TeamMemberItemTag tag, String tid, String account, String desc, GroupMemberBean  memberBean) {
            this.tag = tag;
            this.tid = tid;
