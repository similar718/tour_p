package cn.xmzt.www.nim.uikit.common.util.media;
...
import cn.xmzt.www.nim.uikit.common.media.picker.util.BitmapUtil;
...
public class ImageUtil {
    ...
    public static Boolean scaleImage(File srcFile, File dstFile, int dstMaxWH, CompressFormat compressFormat, int quality) {
        ...
        try {
            ...
            if (srcBitmap == null) {
                srcBitmap=BitmapUtils.ReadBitMap(srcFile.getPath(),inSampleSize);
                if (srcBitmap == null) {
                    return success;
                }
            }
