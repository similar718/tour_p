...
//                mWindow.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    if(dark){
                        mWindow.setStatusBarColor(ContextCompat.getColor(activity,R.color.color_88_49_BE_FF));
                    }else {
                        mWindow.setStatusBarColor(ContextCompat.getColor(activity,R.color.color_00_49_BE_FF));
                    }
                }
    ...
    public static void changeStatusBarColor(Activity activity, int colorId) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(ContextCompat.getColor(TourApplication.context, colorId));
