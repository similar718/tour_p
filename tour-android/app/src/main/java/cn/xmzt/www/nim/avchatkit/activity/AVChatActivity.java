...
import cn.xmzt.www.nim.faceunity.FaceU;
import cn.xmzt.www.nim.faceunity.utils.VersionUtil;
import cn.xmzt.www.nim.avchatkit.AVChatKit;
import cn.xmzt.www.nim.avchatkit.AVChatProfile;
...
import cn.xmzt.www.nim.avchatkit.controll.AVChatController;
import cn.xmzt.www.nim.avchatkit.controll.AVChatSoundPlayer;
import cn.xmzt.www.nim.avchatkit.module.AVChatTimeoutObserver;
import cn.xmzt.www.nim.avchatkit.module.AVSwitchListener;
import cn.xmzt.www.nim.avchatkit.module.SimpleAVChatStateObserver;
import cn.xmzt.www.nim.avchatkit.notification.AVChatNotification;
import cn.xmzt.www.nim.avchatkit.receiver.PhoneCallStateObserver;
import cn.xmzt.www.nim.avchatkit.ui.AVChatAudioUI;
import cn.xmzt.www.nim.avchatkit.ui.AVChatVideoUI;
    ...
    private SimpleAVChatStateObserver avchatStateObserver = new SimpleAVChatStateObserver() {
        ...
        public void onAVRecordingCompletion(String account, String filePath) {
            if (account != null && filePath != null && filePath.length() > 0) {
                ...
                ToastUtils.showText(AVChatActivity.this, msg);
            } else {
                ToastUtils.showText(AVChatActivity.this, "录制已结束.");
            }
    ...
    private void handleCallControl(AVChatControlEvent notification) {
        ...
        switch (notification.getControlCommand()) {
            ...
            case AVChatControlCommand.SWITCH_AUDIO_TO_VIDEO_REJECT:
                rejectAudioToVideo();
                ToastUtils.showText(AVChatActivity.this, R.string.avchat_switch_video_reject);
                break;
            ...
            case AVChatControlCommand.NOTIFY_VIDEO_ON:
                ...
                break;
            default:
                ToastUtils.showText(this, "对方发来指令值：" + notification.getControlCommand());
                break;
        }
    }
        ...
        public void onEvent(AVChatOnlineAckEvent ackInfo) {
            ...
            if (avChatData != null && avChatData.getChatId() == ackInfo.getChatId()) {
                ...
                if (client != null) {
                    ...
                    ToastUtils.showText(AVChatActivity.this, "通话已在" + client + "端被" + option);
                }
                finish();
            }
        }
