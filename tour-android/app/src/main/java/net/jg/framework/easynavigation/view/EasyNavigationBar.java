package net.jg.framework.easynavigation.view;
...
import net.jg.framework.easynavigation.adapter.ViewPagerAdapter;
import net.jg.framework.easynavigation.constant.Anim;
import net.jg.framework.easynavigation.utils.NavigationUtil;
...
public class EasyNavigationBar extends LinearLayout {
    ...
    private int layoutId = R.layout.layout_easynavigation_container;
    ...
    private float navigationHeight = 45;
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        contentView = (RelativeLayout) View.inflate(context, layoutId, null);
    ...
    private void parseStyle(TypedArray attributes) {
        if (attributes != null) {
            layoutId = attributes.getResourceId(R.styleable.EasyNavigationBar_Easy_layoutId, layoutId);
...
//若没有设置中间添加的文字字体大小、颜色、则同其他Tab一样
    ...
    public void buildNavigation() {
        ...
        for (int i = 0; i < tabCount; i++) {
            View itemView = View.inflate(getContext(), R.layout.layout_easynavigation_navigation_tab, null);
...
*/
    ...
    public EasyNavigationBar setLayoutId(int layoutId) {
